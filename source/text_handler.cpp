...
TextHandler::TextHandler(int window_width, int window_height)
            : shader("../source/vertex_shaders/text_shader.vert", "../source/fragment_shaders/text_shader.frag"),
              font_family("Roboto-Regular.ttf"), font_size(48)
{
    initFont();
    createFont();
